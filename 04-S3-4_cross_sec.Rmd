...
To demonstrate how to use the `estiamteNetwork` function from the **bootnet** package, we will use the first 10 questions from the StarWars dataset (part of the **psychnonetrics** package). The data  contains 271 observations and one general Star Wars question and three question about the prequels, three questions about the original and three question about the sequels.
